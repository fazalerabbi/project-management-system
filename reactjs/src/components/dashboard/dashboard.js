...
class DashboardIndex extends Component {
    ...
    render() {
        ...
        let styleWidth66          = { width: "66%" };
        let styleWidth45          = { width: "45%" };
        let styleWidth25          = { width: "25%" };
        let styleWidth5           = { width: "5%" };
        let styleWidth2           = { width: "2%" };
        let styleWidth100         = { width: "100%" };
        let styleWidth37          = { width: "37%" };
        let styleMargin           = { margin: "15px 10px 10px 0" };
        let styleWidthHeight1     = { width: "160px", height: "100px" };
        let styleHeight230        = { height:"230px" };
                        ...
                        <div className="col-md-12 col-sm-12 col-xs-12">
                            <div className="dashboard_graph">
                                ...
                                <div className="row x_title">
                                    ...
                                    <div className="col-md-6">
                                        <div id="reportrange" className="pull-right" style={style1}>
                                ...
                                <div className="col-md-3 col-sm-3 col-xs-12 bg-white">
                                    ...
                                    <div className="col-md-12 col-sm-12 col-xs-6">
                                        <div>
                                            ...
                                            <div className="">
                                                <div className="progress progress_sm" style={styleWidth}>
                    ...
                    <div className="row">
                            ...
                            <div className="x_panel tile fixed_height_320">
                                ...
                                <div className="x_content">
                                    ...
                                    <div className="widget_summary">
                                        ...
                                        <div className="w_center w_55">
                                            <div className="progress">
                                                <div className="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={styleWidth66}>
                                    ...
                                    <div className="widget_summary">
                                        ...
                                        <div className="w_center w_55">
                                            <div className="progress">
                                                <div className="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={styleWidth45}>
                                                    <span className="sr-only">60% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widget_summary">
                                        ...
                                        <div className="w_center w_55">
                                            <div className="progress">
                                                <div className="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={styleWidth25}>
                                                    <span className="sr-only">60% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widget_summary">
                                        ...
                                        <div className="w_center w_55">
                                            <div className="progress">
                                                <div className="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={styleWidth5}>
                                                    <span className="sr-only">60% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="widget_summary">
                                        ...
                                        <div className="w_center w_55">
                                            <div className="progress">
                                                <div className="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={styleWidth2}>
                                                    <span className="sr-only">60% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="col-md-4 col-sm-4 col-xs-12">
                            <div className="x_panel tile fixed_height_320 overflow_hidden">
                                ...
                                <div className="x_content">
                                    <table className="" style={styleWidth100}>
                                        <tbody>
                                        <tr>
                                            <th style={styleWidth37}>
                                                <p>Top 5</p>
                                            </th>
                                            <th>
                                        ...
                                        <tr>
                                            <td>
                                                <canvas className="canvasDoughnut" height="140" width="140" style={styleMargin}></canvas>
                                            </td>
                                            <td>
                                ...
                                <div className="x_content">
                                    <div className="dashboard-widget-content">
                                        ...
                                        <div className="sidebar-widget">
                                            ...
                                            <canvas width="150" height="80" id="chart_gauge_01" className="" style={styleWidthHeight1}></canvas>
                                    ...
                                    <div className="x_panel">
                                        ...
                                        <div className="x_content">
                                            <div className="dashboard-widget-content">
                                                ...
                                                <div id="world-map-gdp" className="col-md-8 col-sm-12 col-xs-12" style={styleHeight230}></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                    ...
                                    <div className="x_content">
                                        ...
                                        <form className="form-horizontal form-label-left" novalidate>
                                            ...
                                            <div className="item form-group">
                                                <label className="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span className="required">*</span>
                                                </label>
                                            ...
                                            <div className="item form-group">
                                                <label className="control-label col-md-3 col-sm-3 col-xs-12" for="website">Website URL <span className="required">*</span>
                                                </label>
                                                <div className="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div className="item form-group">
                                                <label className="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Occupation <span className="required">*</span>
                                                </label>
                                                <div className="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div className="item form-group">
                                                <label for="password" className="control-label col-md-3">Password</label>
                                                <div className="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div className="item form-group">
                                                <label for="password2" className="control-label col-md-3 col-sm-3 col-xs-12">Repeat Password</label>
                                                <div className="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div className="item form-group">
                                                <label className="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Telephone <span className="required">*</span>
                                                </label>
                                                <div className="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div className="item form-group">
                                                <label className="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Textarea <span className="required">*</span>
                                                </label>
                                                <div className="col-md-6 col-sm-6 col-xs-12">
